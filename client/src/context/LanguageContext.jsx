...
const translations = {
  en: {
    ...
    'profile.privacyText':
      'Pharmacist inquiries and their history are stored on PharMate’s server. Your patient code replaces your profile name in inquiry screens, but anything you type may identify you. You can manage inquiry consent separately. Caregiver access requires an approved link.',
  ...
  fil: {
    ...
    'nav.ask': 'Magtanong',
    'nav.appointments': 'Bisita',
    'nav.orders': 'Mga Order',
    'nav.profile': 'Profile',
    'profile.title': 'Profile',
    'profile.subtitle': 'Baguhin ang iyong profile.',
    ...
    'profile.edit': 'Baguhin ang Profile',
    ...
    'profile.privacyText':
      'Nakaimbak sa server ng PharMate ang mga inquiry at kasaysayan nito. Patient code ang kapalit ng pangalan sa inquiry screens, ngunit maaaring makilala ka sa isinusulat mo. Hiwalay na mapapamahalaan ang pahintulot sa inquiry. Kailangan ng aprubadong link para sa caregiver access.',
