...
export default function ProfileRedesign() {
  ...
  async function generateCode() {
    ...
    setError('');
    try {
      const response = await api('/api/patient/invite', { method: 'POST' });
    ...
    <main className="pm-profile-page">
      ...
      <section className="pm-profile-identity">
        ...
        <div>
          ...
          <dl>
            <div>
              <dt>▣ {t('profile.member')}</dt>
              <dd>{memberSince}</dd>
            </div>
            <div>
              <dt>▤ {t('profile.patientId')}</dt>
        ...
        <div className="pm-caregiver-code">
          ...
          {invite ? (
            <>
              ...
              <p>Single-use · expires {new Date(invite.expires_at).toLocaleString()}</p>
            </>
          ) : (
            <>
          ...
          <div>
            <button disabled={!invite} onClick={shareCode}>
              ⌯ {t('profile.share')}
            </button>
            <button disabled={!invite} onClick={copyCode}>
              ▣ {t('profile.copy')}
            </button>
