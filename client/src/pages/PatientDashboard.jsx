    ...
    <div className="d-flex">
      <nav className="pm-sidebar d-flex flex-column p-3">
        ...
        <ul className="nav flex-column gap-1 flex-grow-1">
          ...
          <li><a href="/patient/onboarding" className="nav-link text-white-50">Schedule Settings</a></li>
        </ul>
      ...
      <main className="pm-content">
        ...
        <p className="text-muted small mb-4">Patient code: <strong>{user?.patientCode ?? '—'}</strong></p>
